          ...
          <div className="flex items-center justify-between bg-white dark:bg-gray-800 p-2.5 rounded-2xl border border-gray-200/60 dark:border-gray-700 shadow-sm">
            <div className="flex items-center gap-2.5 min-w-0">
              ...
              <div className="truncate">
                <h4 className="text-xs font-extrabold text-gray-900 dark:text-white truncate">Farmer Account</h4>
                <p className="text-[10px] text-emerald-600 dark:text-emerald-400 font-bold">● Active Session</p>
              </div>
            </div>
            <NotificationBell />
          </div>
